...
<head>
    ...
    <?= $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.js') ?>
    <?= $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/chosen/1.8.7/chosen.css') ?>
    <?= $this->Html->script('https://cdnjs.cloudflare.com/ajax/libs/chosen/1.8.7/chosen.jquery.js') ?>
